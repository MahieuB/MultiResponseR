...
#'
#' @description This function plots the results coming from \code{\link[MultiResponseR]{mr.sig.cell}}
#'
#' @param x A list returned by \code{\link[MultiResponseR]{mr.sig.cell}}
...
#'
#' plot(res)
plot.mr.sig.cell=function(x,alpha.1=0.05,alpha.2=0,choice="percent.derived.cont",col.greater.1="green3",col.lower.1="orangered",col.greater.2="lightgreen",col.lower.2="lightsalmon",...){
  if (!inherits(x,"mr.sig.cell")){
    stop("class(x) must be mr.sig.cell")
  }
