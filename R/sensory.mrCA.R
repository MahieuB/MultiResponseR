...
#' \describe{
#'   \item{mrCA}{Results of the mrCA}
#'   \item{coord.plot.desc}{Coordinates of the descriptors on the plot: they differ from those of mrCA$col.coord by an expansion factor}
